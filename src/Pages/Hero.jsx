          ...
          <div className="w-[60%]">
            ...
            <div className="flex flex-col gap-8">
              <div className="flex flex-row gap-5">
                ...
                <button className="group btn btn-soft bg-transparent relative overflow-hidden rounded-lg border-2 border-primary px-3 py-3 font-semibold text-primary transition-colors duration-300 hover:text-black">
